...
void* threadfunc(void* thread_param)
{
    ...
    int wait_to_obtain_sec = thread_func_args->wait_to_obtain_ms / 1000;
    int wait_to_release_sec = thread_func_args->wait_to_release_ms / 1000;

    sleep(wait_to_obtain_sec);
